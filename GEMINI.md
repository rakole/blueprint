...
- The live runtime now includes `/blu:plan-phase`, `/blu:execute-phase`, `/blu:validate-phase`, `/blu:verify-work`, `/blu:quick`, `/blu:pause-work`, `/blu:resume-work`, `/blu:add-phase`, `/blu:insert-phase`, `/blu:remove-phase`, `/blu:plan-milestone-gaps`, `/blu:audit-milestone`, `/blu:complete-milestone`, `/blu:milestone-summary`, `/blu:new-milestone`, `/blu:add-backlog`, `/blu:docs-update`, `/blu:list-phase-assumptions`, and `/blu:secure-phase`. Current follow-up work is keeping the shipped discovery, planning, execution, validation/UAT, lightweight execution, governance, roadmap-admin, capture, docs, and review contracts aligned while later commands remain blocked until their substrate exists.
