...
- The current repair focus is making the shipped discovery, execution, and validation commands fully substantive before Phase 4 expands, while `verify-work` remains planned.
