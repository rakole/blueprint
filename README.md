...
- Wave 2 milestone auditing now ships through `/blu:audit-milestone`, which compares original milestone intent against completed phase evidence and writes a durable report in `.blueprint/reports/`
...
The next broad rollout starts with the remaining roadmap slice while the shipped Phase 3, Phase 4, governance handoff/resume, and milestone-audit guarantees stay green:
...
3. Preserve the shipped pause/resume routing, validation parity, and milestone-audit report contract while the rest of the roadmap slice lands
