...
|---:|---|---|---|---|
| 1 | `remove-workspace` | none | none | `update`, `reapply-patches`, `new-workspace`, `workstreams`, `undo`, and `cleanup` are now shipped; the remaining maintenance work is the deferred workspace-removal surface. |
