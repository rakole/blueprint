...
Ordering policy: incomplete commands are bubbled up; completed commands are bubbled down. Importance is prioritized by the immediate next slice (`add-phase`), then by wave, then by risk (High -> Medium -> Low).
...
|---:|---|---|---|---:|---|---|
| 1 | `add-phase` | ❌ | `planned` | 2 | `Roadmap And Milestone` | Medium |
...
|---:|---|---|---|---|
| 1 | `add-phase` | `audit-milestone` | none | Safe parallel set. |
...
| 12 | `reapply-patches` | `remove-workspace` | none | Safe parallel set. |
...
| 18 | `audit-milestone` | ✅ | `implemented` | 2 | `Roadmap And Milestone` | Low |
