...
`review` carries forward the GSD intent to request cross-AI peer review of phase plans from external AI CLIs. In Blueprint it should stay Gemini-native, delegate persistence to documented MCP tools, and keep the repo-side contract explicit enough that this command can be implemented in isolation later.
...
- `phase XX-REVIEWS.md or equivalent peer-review artifact`
