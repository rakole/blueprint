...
- JSON Schema owns required fields, unsupported fields, static enums, status alignment, single-line sink safety, path-shape restrictions, evidence-ref minima, and runtime narrowing for exact evidence ids and finding projections.
