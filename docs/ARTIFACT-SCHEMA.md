...
- ROADMAP phase checklist lines use exactly `- [ ] Phase N: Title (Requirements: REQ-01, REQ-02)` or `- [x] Phase N: Title`; Phase Details headings use exactly `### Phase N: Title`. Bold `Phase` labels and dash separators are non-canonical.
