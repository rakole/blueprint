...
| `plan-phase` | 1 | `Core Lifecycle` | `blueprint-phase-planning` | `blocked` | `one or more XX-YY-PLAN.md files; .blueprint/STATE.md` | `Medium: can replace plans and change downstream execution order.` |
...
| `ui-phase` | 1 | `Core Lifecycle` | `blueprint-phase-discovery` | `planned` | `phase XX-UI-SPEC.md; .blueprint/STATE.md` | `Low: writes a UI design contract only.` |
