...
| `blueprint-roadmap-admin` | `implemented` | Roadmap and milestone mutations, milestone audits, and archival prep | `add-phase`, `insert-phase`, `remove-phase`, `plan-milestone-gaps`, `audit-milestone`, `complete-milestone`, `milestone-summary`, `new-milestone` |
