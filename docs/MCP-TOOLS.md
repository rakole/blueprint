...
| `blueprint_phase_context` | Summarize phase boundary, project brief, requirements grounding, workflow posture, existing artifacts, any mapped codebase context, and the mirrored effective external-research policy in `workflowPosture.research.externalSources` | `{phase, projectBrief, requirementsGrounding, workflowPosture, codebase, requirements, missingArtifacts, warnings}` |
