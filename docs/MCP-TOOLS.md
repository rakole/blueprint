...
| `blueprint_review_record` | Persist a phase-scoped review artifact such as `XX-SECURITY.md`, `XX-REVIEW.md`, or `XX-UI-REVIEW.md` with overwrite protection | `{reportPath, counts, followUps, status, warnings}` |
