...
- runtime command manifests for the shipped Wave 0, discovery, planning, execution, validation/UAT, lightweight execution, governance, current roadmap-admin, review, docs, and review-branch surfaces
...
The next milestone is successful when the shipped lifecycle, governance, roadmap-admin, capture, review, docs, and review-branch commands keep their current guarantees intact, the Wave 2 closeout trio plus `insert-phase` stay aligned across docs and runtime, and later commands remain blocked until their substrate exists.
