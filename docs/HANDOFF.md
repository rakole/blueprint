...
- runtime command manifests for the shipped Wave 0, discovery, planning, execution, validation/UAT, lightweight execution, governance, current roadmap-admin, review, docs, plan-run, and maintenance surfaces
- shipped `blueprint-roadmap-admin` skill file for the roadmap append, removal, gap-planning, and milestone audit slice
- shipped Wave 0, discovery, planning, execution, validation, review, governance, roadmap-admin, docs, debug, plan-run, and maintenance skill files in `skills/`
