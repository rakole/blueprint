...
The next milestone is successful when the shipped lifecycle, governance, roadmap-admin, capture, review, docs, review-branch, workspace, patch-replay, and advisory update commands keep their current guarantees intact, the Wave 2 closeout trio plus `insert-phase` stay aligned across docs and runtime, and later commands remain blocked until their substrate exists.
