...
- `resume-work` reconstructs context from the canonical `pause-work` handoff schema plus phase artifacts; `STATE.md` supplies current position and next-action routing.
