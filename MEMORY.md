...
- implement `/blu-impact` from `docs/IMPACT-WORKFLOW-IMPLEMENTATION-PLAN.md` one phase at a time; Phase 0 and Phase 1 keep it planned and non-routable while documenting the command-surface decision, catalog row, and command spec before any manifest or primary skill is added
