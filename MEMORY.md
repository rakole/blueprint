...
- `remove-workspace` shipped on 2026-04-23 on top of `blueprint_workspace_registry_get`, `blueprint_workspace_remove`, the `blueprint-maintenance` skill, and host-global workspace registry teardown with transactional rollback and renewable lock protection
