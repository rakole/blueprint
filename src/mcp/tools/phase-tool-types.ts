...
import type {
  PhasePlanExternalServicePrerequisite,
  PhasePlanStructuredModel
...
export type PhaseValidationStandaloneValidateModelResult = Omit<
...
export type RoadmapAddPhaseRequirementValidationStatus =
  | "declared"
...
export type PhaseSelectionResult = Pick<
  PhaseLocateResult,
  | "found"
  | "phaseNumber"
  | "phasePrefix"
...
export type PhasePlanStandaloneValidateModelResult = Omit<
  PhasePlanValidateModelResult,
  "taskSchema" | "normalizedModel" | "renderPreview"
>;

export type PhasePlanWriteModelValidationResult = Omit<
  PhasePlanValidateModelResult,
  "taskSchema" | "normalizedModel" | "renderPreview"
>;
...
export type PhaseSummaryStandaloneValidateModelResult = Omit<
