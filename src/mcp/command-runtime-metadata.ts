...
export const MILESTONE_SUMMARY_RUNTIME_METADATA = {
  ...
  spec: {
    ...
    rootRoutable: true,
    purpose:
      "`milestone-summary` builds a durable consolidated milestone spec from saved roadmap, audit, and completion evidence and routes toward the next milestone-start action.",
    reads: [
      "blueprint_roadmap_read -> {roadmap, milestone, phases}",
      "blueprint_artifact_list -> {artifacts, reports, missing}",
...
export const NEW_MILESTONE_RUNTIME_METADATA = {
  ...
  spec: {
    ...
    rootRoutable: true,
    purpose:
      "`new-milestone` starts a new milestone cycle by deriving carry-forward context from the saved consolidated milestone spec, scaffolding starter docs and the first phase context, and preserving historical phase artifacts.",
    reads: [
      "blueprint_roadmap_read -> {roadmap, milestone, phases}",
      ...
      "typed Roadmapper Packet built by the parent from digestScope, carryForwardFacts, requirementTransitionHints, and a relative firstPhasePreview only"
    ],
    writes: [
      ".blueprint/PROJECT.md",
      ".blueprint/REQUIREMENTS.md",
