...
export const DISCUSS_PHASE_RUNTIME_METADATA = {
  ...
  spec: {
    ...
    rootRoutable: true,
    purpose:
      "`discuss-phase` gathers durable phase context through adaptive discovery, capability-gated gray-area research sidecars, resumable notes, first-attempt authoring, and MCP-owned phase artifact writes.",
