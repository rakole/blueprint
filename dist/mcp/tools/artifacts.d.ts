...
export declare const SCAFFOLD_GENERATED_MARKER = "*Generated by `blueprint_artifact_scaffold`*";
export declare const BOOTSTRAP_STARTER_CONTEXT_MARKER = "*Bootstrap starter context: replace through `/blu-discuss-phase`*";
...
export declare function isScaffoldGeneratedArtifact(content: string): boolean;
export declare function isBootstrapStarterContext(content: string): boolean;
