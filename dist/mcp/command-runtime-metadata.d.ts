...
export declare const PLAN_PHASE_RUNTIME_METADATA: {
    ...
    readonly requiredTools: readonly ["blueprint_phase_locate", "blueprint_artifact_contract_read", "blueprint_phase_context", "blueprint_phase_research_status", "blueprint_phase_artifact_read", "blueprint_phase_validation_read", "blueprint_review_load_findings", "blueprint_phase_plan_index", "blueprint_phase_plan_read", "blueprint_phase_plan_readiness", "blueprint_phase_plan_authoring_context", "blueprint_phase_plan_validate_model", "blueprint_phase_plan_write", "blueprint_phase_plan_validate", "blueprint_config_get", "blueprint_state_load", "blueprint_state_update"];
    ...
    readonly spec: {
        ...
        readonly reads: readonly ["Phase resolution, context, planning readiness, saved discovery artifacts including optional phase-local XX-SPEC.md when present, validation and review evidence, plan inventory, plan authoring schema, effective config, and state through MCP."];
