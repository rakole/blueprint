...
export declare const MILESTONE_SUMMARY_RUNTIME_METADATA: {
    ...
    readonly spec: {
        ...
        readonly executionProfile: "interactive-read";
        readonly rootRoutable: true;
        readonly purpose: "`milestone-summary` builds a durable consolidated milestone spec from saved roadmap, audit, and completion evidence and routes toward the next milestone-start action.";
...
export declare const NEW_MILESTONE_RUNTIME_METADATA: {
    ...
    readonly spec: {
        ...
        readonly executionProfile: "interactive-read";
        readonly rootRoutable: true;
        readonly purpose: "`new-milestone` starts a new milestone cycle by deriving carry-forward context from the saved consolidated milestone spec, scaffolding starter docs and the first phase context, and preserving historical phase artifacts.";
...
export declare const NEXT_RUNTIME_METADATA: {
    ...
    readonly catalog: {
        ...
        readonly primarySkill: "blueprint-router";
        readonly declaredStatus: "implemented";
        readonly risk: "Low: read-only next-step routing from project status, effective config, state, artifacts, and the live command catalog.";
    };
    readonly requiredTools: readonly ["blueprint_project_status", "blueprint_config_get", "blueprint_state_load", "blueprint_artifact_list", "blueprint_command_catalog"];
    readonly optionalAgents: readonly [];
    ...
    readonly spec: {
        ...
        readonly reads: readonly [".blueprint/ effective config, state, artifact inventory, project status, and command catalog through MCP tools."];
        readonly writes: readonly [];
    };
    readonly runtimeReference: {
        readonly path: string;
...
export declare const MAP_CODEBASE_RUNTIME_METADATA: {
    ...
    readonly spec: {
        ...
        readonly executionProfile: "long-running-mutation";
        readonly rootRoutable: true;
        readonly purpose: "`map-codebase` prepares selected repository evidence and directly publishes the generated seven-document compatibility views, with explicit portable format v1 opt-in for an INDEX.md plus a complete immutable generation. Valid maps are reused by default; focus areas deepen the same bundle.";
        readonly reads: readonly ["Selected repository evidence and generated map state through blueprint_map_prepare"];
        readonly writes: readonly [".blueprint/codebase/INDEX.md and its referenced generations/<generation-id>/", ".blueprint/codebase/{STACK,ARCHITECTURE,STRUCTURE,CONVENTIONS,TESTING,INTEGRATIONS,CONCERNS}.md compatibility views when applicable", "an explicitly selected existing repository instruction file only when linkInstructions is requested"];
    };
    readonly runtimeReference: {
        readonly path: string;
        readonly waveTitle: "Foundation";
        ...
        readonly primarySkill: "blueprint-map";
        readonly exactMcpDestination: readonly ["blueprint_map_prepare", "blueprint_map_submit"];
        readonly optionalAgents: readonly ["blueprint-mapper"];
        readonly hookInvolvement: readonly ["read-before-edit", ".blueprint write guard"];
...
export declare const DISCUSS_PHASE_RUNTIME_METADATA: {
    ...
    readonly spec: {
        ...
        readonly executionProfile: "long-running-mutation";
        readonly rootRoutable: true;
        readonly purpose: "`discuss-phase` gathers durable phase context through adaptive discovery, capability-gated gray-area research sidecars, resumable notes, first-attempt authoring, and MCP-owned phase artifact writes.";
        readonly reads: readonly ["blueprint_discuss_prepare bundles selected phase, roadmap, effective config, artifacts, bounded relevant prior context, codebase evidence, plan inventory, notes and authoring schema/defaults/missing essentials; canonical baselines and mutable state remain separate."];
        readonly writes: readonly ["starter phase directory and phase XX-CONTEXT.md for planned roadmap-only phases", "phase XX-CONTEXT.md", "optional phase XX-DISCUSSION-LOG.md", "phase XX-DISCUSS-SESSION.json v2 notes, evidence basis and metadata-only publication journal; no generated document drafts", ".blueprint/STATE.md"];
    };
    readonly runtimeReference: {
        readonly path: string;
        readonly waveTitle: "Core Lifecycle";
...
export declare const PLAN_PHASE_RUNTIME_METADATA: {
    ...
    readonly requiredTools: readonly ["blueprint_plan_prepare", "blueprint_plan_submit", "blueprint_plan_read"];
    ...
    readonly spec: {
        ...
        readonly executionProfile: "long-running-mutation";
        readonly rootRoutable: true;
        readonly purpose: "`plan-phase` prepares grounded authoring inputs, compiles compact models into execution-ready phase.plan artifacts, and publishes a complete checked set without storing rejected drafts.";
        readonly reads: readonly ["blueprint_plan_prepare supplies a stable phase evidence snapshot, optional XX-SPEC.md, project and requirement grounding, research/UI readiness, effective config, saved-plan inventory and compact schema/example/validation rules; blueprint_plan_read returns canonical plans and metadata."];
        readonly writes: readonly ["phase-scoped preparation metadata, evidence fingerprints and metadata-only publication journal", ".blueprint/phases/<phase>/<phase-prefix>-<plan-id>-PLAN.md (XX-YY-PLAN.md) through blueprint_plan_submit", ".blueprint/STATE.md through submit-owned synced state update"];
    };
    readonly runtimeReference: {
        readonly path: string;
        readonly waveTitle: "Core Lifecycle";
        ...
        readonly primarySkill: "blueprint-phase-planning";
        readonly exactMcpDestination: readonly ["blueprint_plan_prepare", "blueprint_plan_submit", "blueprint_plan_read"];
        readonly optionalAgents: readonly ["blueprint-planner", "blueprint-checker"];
        readonly hookInvolvement: readonly ["read-before-edit", ".blueprint write guard"];
...
export declare const SPEC_PHASE_RUNTIME_METADATA: {
    readonly commandName: "spec-phase";
    readonly sourceId: string;
    readonly catalog: {
        readonly wave: 1;
        readonly family: "Core Lifecycle";
        readonly primarySkill: "blueprint-phase-discovery";
        readonly declaredStatus: "implemented";
        readonly risk: "Low: optional pre-discussion requirements clarification writes one phase-scoped spec artifact and synced state only.";
    };
    ...
    readonly spec: {
        ...
        readonly executionProfile: "long-running-mutation";
        readonly rootRoutable: true;
        readonly purpose: "`spec-phase` clarifies what a Blueprint phase should deliver and writes the optional phase-scoped spec artifact before later discovery and planning flows.";
        readonly reads: readonly ["Phase resolution, roadmap requirements, state, codebase summaries, artifact inventory, effective config, any existing spec, phase.spec contract inputs, refreshed command catalog state, and synced state through MCP."];
        readonly writes: readonly ["canonical phase XX-SPEC.md artifact through blueprint_phase_artifact_write with artifact spec", ".blueprint/STATE.md through synced state update after a valid write or no-write route"];
    };
    readonly runtimeReference: {
        readonly path: string;
        readonly waveTitle: "Core Lifecycle";
        readonly command: "spec-phase";
        readonly primarySkill: "blueprint-phase-discovery";
        readonly exactMcpDestination: readonly ["blueprint_phase_locate", "blueprint_phase_context", "blueprint_roadmap_read", "blueprint_artifact_list", "blueprint_config_get", "blueprint_phase_artifact_read", "blueprint_phase_artifact_write", "blueprint_artifact_contract_read", "blueprint_state_load", "blueprint_state_update", "blueprint_command_catalog"];
        readonly optionalAgents: readonly [];
        readonly hookInvolvement: readonly ["read-before-edit", ".blueprint write guard"];
        readonly contractNotes: "Implemented runtime-owned behavior: load skills/blueprint-phase-discovery/references/spec-phase-runtime-contract.md as the active behavior contract, resolve through blueprint_phase_context before fallback locate, read existing spec and the live phase.spec contract before drafting, run the existing-spec update/view/skip gate, use the quantitative ambiguity formula and six-round Socratic loop, persist only through blueprint_phase_artifact_write with artifact spec, then sync state and prove the next safe implemented action through blueprint_command_catalog. Treat missing spec as nonblocking for normal discuss/research/plan lifecycle; recommend /blu-spec-phase only when the catalog proves it implemented for spec-first planning, ambiguous roadmap or context gaps, or stale/contradictory saved spec evidence.";
        readonly evidenceState: readonly ["locked", "runtime-owned", "needs-behavior-audit"];
    };
};
export declare const UI_PHASE_RUNTIME_METADATA: {
    ...
    readonly runtimeReference: {
        ...
        readonly primarySkill: "blueprint-phase-discovery";
        readonly exactMcpDestination: readonly ["blueprint_phase_locate", "blueprint_phase_research_status", "blueprint_config_get", "blueprint_phase_artifact_read", "blueprint_phase_ui_skip_write", "blueprint_artifact_contract_read", "blueprint_phase_artifact_write", "blueprint_artifact_scaffold", "blueprint_state_load", "blueprint_command_catalog", "blueprint_state_update"];
        readonly optionalAgents: readonly ["blueprint-ui-designer", "blueprint-checker"];
        readonly hookInvolvement: readonly ["read-before-edit", ".blueprint write guard"];
...
export declare const EXECUTE_PHASE_RUNTIME_METADATA: {
    ...
    readonly requiredTools: readonly ["blueprint_phase_execution_prepare", "blueprint_phase_execution_apply", "blueprint_phase_execution_verify", "blueprint_phase_execution_finalize"];
    readonly optionalAgents: readonly [];
    readonly spec: {
        readonly path: string;
        ...
        readonly reads: readonly ["one immutable execution packet through blueprint_phase_execution_prepare", "selected plan bodies, effective config, repo HEAD/status, preimages, summaries, and external prerequisites bound into that packet"];
        readonly writes: readonly ["selected plan-owned repository files through blueprint_phase_execution_apply", "durable execute-phase session receipts under .blueprint/executions/execute-phase/", "one XX-YY-SUMMARY.md per finalized plan", ".blueprint/STATE.md"];
    };
    readonly runtimeReference: {
        readonly path: string;
        readonly waveTitle: "Core Lifecycle";
        ...
        readonly primarySkill: "blueprint-phase-execution";
        readonly exactMcpDestination: readonly ["blueprint_phase_execution_prepare", "blueprint_phase_execution_apply", "blueprint_phase_execution_verify", "blueprint_phase_execution_finalize"];
        readonly optionalAgents: readonly [];
...
export declare const LIST_PHASE_ASSUMPTIONS_RUNTIME_METADATA: {
    ...
    readonly spec: {
        ...
        readonly reads: readonly ["Phase resolution, phase context, roadmap state, project status, and effective config through MCP."];
        readonly writes: readonly [];
    };
    readonly runtimeReference: {
        readonly path: string;
...
export declare const WORKSTREAMS_RUNTIME_METADATA: {
    ...
    readonly requiredTools: readonly ["blueprint_workstream_list", "blueprint_workstream_mutate"];
    readonly optionalAgents: readonly [];
    ...
    readonly spec: {
        ...
        readonly writes: readonly [".blueprint/workstreams/WORKSTREAMS.md", ".blueprint/workstreams/<slug>/state.json", ".blueprint/STATE.md during resume snapshot restoration"];
    };
    readonly runtimeReference: {
        readonly path: string;
        readonly waveTitle: "Workspace And Maintenance";
...
export declare const CLEANUP_RUNTIME_METADATA: {
    ...
    readonly requiredTools: readonly ["blueprint_project_status", "blueprint_roadmap_read", "blueprint_artifact_list", "blueprint_artifact_summary_digest", "blueprint_cleanup_archive", "blueprint_state_update"];
    readonly optionalAgents: readonly [];
    ...
    readonly spec: {
        ...
        readonly writes: readonly [".blueprint/reports/cleanup-latest.md through blueprint_cleanup_archive", ".blueprint/STATE.md when routing changes", "confirmed phase archive destination through blueprint_cleanup_archive"];
    };
    readonly runtimeReference: {
        readonly path: string;
        readonly waveTitle: "Workspace And Maintenance";
